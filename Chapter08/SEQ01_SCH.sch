...
<drawing version="7">
    ...
    <netlist>
        ...
        <block symbolname="SBASE_TIMER_CB24RM" name="XLXI_33">
            ...
            <blockpin signalname="XLXN_167" name="TRG_ONE" />
    ...
    <sheet sheetnum="1" width="2304" height="2688">
        ...
        <branch name="XLXN_167">
            <wire x2="848" y1="416" y2="416" x1="560" />
        ...
        <text style="fontsize:48;fontname:Arial" x="76" y="136">SEQ01_SCH</text>
        <branch name="PSW0">
            <wire x2="336" y1="416" y2="416" x1="256" />
        </branch>
        <instance x="336" y="448" name="XLXI_15" orien="R0" />
        <iomarker fontsize="28" x="256" y="416" name="PSW0" orien="R180" />
    </sheet>
</drawing>